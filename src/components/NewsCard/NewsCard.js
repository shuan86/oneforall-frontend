    ...
    <div className="content">
      ...
      <div className="article">
        ...
        {articleStatus == ArticleStatus.underReview || articleStatus == ArticleStatus.verified ? (
          <div>
            {reviewResult == 2 ?
              <h2 className="reviewResult" style={{color:"var(--navy-blue)"}}>審查者認為本消息是真的</h2> :
              <h2 className="reviewResult" style={{color:"var(--brown)"}}>審查者認為本消息是假的</h2>
            }
            ...
            <div className="articleContent">
              ...
              <p>{decisionReason}</p>{/*審查者給的內容*/}
            </div>
          </div>
        ) : null}
        <div className={articleStatus == ArticleStatus.underReview || articleStatus == ArticleStatus.verified ? "articleContent underReview" : "articleContent"}>

...
const RankingTable = () => {
  ...
  const [leaders, setLeaders] = useState([
    { id: 1, account: 'Uenify', exp: 350 },
    { id: 3, account: 'Kekland', exp: 275 },
    { id: 2, account: 'Madopew', exp: 220 },
    { id: 4, account: 'Yussend', exp: 200 },
    { id: 5, account: 'Admin', exp: 175 }
  ])
              ...
              <div className="leader-wrap">
                {i < 3 ? (
                  ...
                  >
                    ...
                    {/* {
                      i + 1 == 1 ? <img src={Gold500} style={{ width: "45px", height: "45px" }} /> : null
                    }
                    {
                      i + 1 == 2 ? <img src={Silver120} style={{ width: "45px", height: "45px" }} /> : null
                    }
                    {
                      i + 1 == 3 ? <img src={Copper30} style={{ width: "45px", height: "45px" }} /> : null
                    } */}
                  </div>
                ) : null}

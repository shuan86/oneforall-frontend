...
import novice_teaching_pixel_image from "../../public/images/dialogs/novice_teaching_pixel.png";
...
const NovicePixelDialog = ({ isOpen, setIsOpen }) => {
    ...
    return (
        <div>
            ...
            >
                ...
                <DialogContent>
                    <img src={novice_teaching_pixel_image} style={imageStyle} alt="" />
                </DialogContent>
                <DialogActions>
...
export default NovicePixelDialog;
...
module.exports = function (env) {
   ...
   */
  var isProduction = env && env.production === true;
  return {
    ...
    }), new ExtractTextPlugin('static/css/[name].[hash].css'), new webpack.HotModuleReplacementPlugin(), // 用于热加载
    // 可以替换代码中的变量
    // https://webpack.js.org/plugins/define-plugin/#use-case-service-urls
    new webpack.DefinePlugin({
      'SERVICE_URL': isProduction ? JSON.stringify("http://pro.example.com") : JSON.stringify("http://dev.example.com"),
      "process.env": {
